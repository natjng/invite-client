...
import { rsvpEvent } from '../actions/eventActions';
...
class EventPreview extends React.Component {
    ...
    render() {       
        ...
        const rsvpButton = this.props.currentUser.events.find(event => event.id === parseInt(this.props.event.id, 10)) ? <Button variant="light" size="sm" >Going</Button> : <Button variant="primary" size="sm" onClick={() => this.handleClick(this.props.event.id)} >RSVP</Button>
